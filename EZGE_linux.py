...
def print_note():
    ...
    folder_name = v10.get()
    c = os.getcwd()
    with open('./'+folder_name+'/03_Notes/Notes.txt','w') as f:
...
def create_folders():
    folder_name = v10.get()
    c = os.getcwd()
    os.makedirs('./'+folder_name+'/01_Forensic Image_E01')
    os.makedirs('./'+folder_name+'/02_Photos')
    os.makedirs('./'+folder_name+'/03_Notes')
